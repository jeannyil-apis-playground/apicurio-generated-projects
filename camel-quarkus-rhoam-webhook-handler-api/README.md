...
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] The deployed application can be accessed at: http://camel-quarkus-rhoam-webhook-handler-api-camel-quarkus-jvm.apps.jeannyil.sandbox1420.opentlc.com
        ...
        "servers": [
            {
                ...
                "url": "http://rhoam-webhook-events-handler-api.apps.jeannyil.sandbox1420.opentlc.com"
            }
        ]
    }
    ```
